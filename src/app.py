...
def lista_alumnos():
    try:
        ...
        return jsonify ({"message":"Error al conectar la base de datos {}".format(ex),'exito':False})
...
def leer_alumno_bd(matricula):
    try:
        ...
        return jsonify ({"message":"Error al conectar la base de datos {}"})
...
@app.route('/alumnos/<mat>', methods=['PUT']) #/servicios para hacer una modificacion PUT
